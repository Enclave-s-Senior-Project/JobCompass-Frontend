...
export default function TermsPage() {
    return (
        <div className="mx-auto flex max-w-7xl flex-col flex-wrap-reverse gap-8 py-12 md:flex-row">
            <main className="flex-1">
                <section id="terms" className="mb-16 scroll-mt-16">
                    <h1 className="mb-4 text-2xl font-bold">1. Terms & Conditions</h1>
                ...
                <section id="limitations" className="mb-16 scroll-mt-16">
                    <h2 className="mb-4 text-2xl font-bold">2. Limitations</h2>
                    <p className="mb-4 text-gray-700">
                ...
                <section id="security" className="mb-16 scroll-mt-16">
                    <h2 className="mb-4 text-2xl font-bold">3. Security</h2>
                    <p className="mb-4 text-gray-700">
                ...
                <section id="privacy" className="mb-16 scroll-mt-16">
                    <h2 className="mb-4 text-2xl font-bold">4. Privacy Policy</h2>
                    <p className="mb-4 text-gray-700">
            ...
            <aside className="shrink-0 md:w-64">
                <Card className="sticky top-8 rounded-md p-6">
                    <h3 className="mb-4 text-xs font-semibold uppercase text-gray-500">TABLE OF CONTENTS</h3>
                    <nav className="space-y-2">
                        <Link
                            href="#terms"
                            className="block text-sm text-primary-600 transition-all hover:font-semibold hover:text-primary-700"
                        >
                            1. Terms & Conditions
                        </Link>
                        <Link
